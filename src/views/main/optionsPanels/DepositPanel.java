...
public class DepositPanel extends JPanel {
	...
	private BankButton buttonMakeDeposit;
	private BankButtonIcon buttonShowPassword;
	private GridBagConstraints gbc;

	public DepositPanel(ActionListener listener) {
	...
	private void initComponents(ActionListener listener) {
		...
		buttonMakeDeposit = new BankButton(Constants.createInstance().getProperty(Constants.TEXT_DEPOSIT),
				Constants.COMMAND_BUTTON_MAKE_DEPOSIT, listener, Constants.COLOR_BACKGROUND_P,
				Constants.COLOR_BACKGROUND_S, 170, 30);
		...
		gbc.gridy = 2;
		gbc.gridx = 1;
		this.add(buttonMakeDeposit, gbc);
	}
